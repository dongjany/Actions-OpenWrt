...
# ========== 一次克隆 → 移动多个目录（你要的格式） ==========
git_clone_move main https://github.com/kiddin9/op-packages luci-app-turboacc luci-app-demon luci-app-xunlei luci-app-fan v2dat mosdns luci-app-mosdns luci-app-broadbandacc autocore automount
